...
<script src="<?php echo get_template_directory_uri();?>/assets/js/planetaryjs.js"></script>
...
(function() {
  ...
  planet.loadPlugin(planetaryjs.plugins.earth({
    topojson: { file:   '<?php echo get_template_directory_uri();?>/assets/js/world-110m.json' },
    oceans:   { fill:   '#011320' },
    land:     { fill:   '#06304e' },
