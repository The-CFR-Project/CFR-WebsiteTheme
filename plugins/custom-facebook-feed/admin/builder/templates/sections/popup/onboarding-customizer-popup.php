...
<div v-for="tooltip in customizeScreensText.onboarding.tooltips"
     ...
     v-bind:id="'sb-onboarding-tooltip-' + customizeScreensText.onboarding.type + '-' + tooltip.step" class="cff-fb-popup-inside sb-onboarding-tooltip cff-fb-source-top" v-bind:class="'sb-onboarding-tooltip-' + tooltip.step" v-bind:data-step="tooltip.step">
